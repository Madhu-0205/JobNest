            ...
            <CardContent className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2 border-t border-border/10 pt-3">
                ...
                <div className="flex gap-2">
                  ...
                  <Button size="sm" onClick={handleDeposit} className="bg-amber-600 hover:bg-amber-700 text-xs px-3 h-8.5">{i18nT("Deposit")}
              ...
              <div className="flex flex-col gap-2 border-t border-border/10 pt-3">
                ...
                <div className="flex gap-2">
                  ...
                  <Button size="sm" onClick={handlePayout} className="bg-amber-600 hover:bg-amber-700 text-xs px-3 h-8.5">{i18nT("Payout")}
              ...
              <div className="bg-black/35 rounded-xl border border-border/40 p-2.5 font-mono text-[9px] h-[170px] overflow-y-auto flex flex-col gap-2 text-muted-foreground">
                ...
                <div key={item.id} className="flex justify-between items-center border-b border-border/10 pb-1.5 last:border-0 last:pb-0">
                    <div className="flex flex-col">
                      ...
                      <span className="text-[8px] opacity-60">{i18nT("Type:")}{item.refType} • {item.time}</span>
                    </div>
            ...
            <CardContent className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex gap-2">
                  ...
                  <Button size="sm" onClick={handleApplyCoupon} className="h-8 text-xs">{i18nT("Apply")}
