...
export default function GeospatialDashboard() {const { t: i18nT } = useI18n();
  // Locale State
            ...
            <CardContent className="flex flex-col gap-4">
              <div className="flex items-end gap-2">
                ...
                <Button
                  ...
                  className="whitespace-nowrap">{i18nT("Search")}
              ...
              <div className="flex flex-col gap-2 text-xs bg-muted/30 p-3 rounded-lg border border-border">
                  <div className="flex justify-between border-b border-border/50 pb-1">
                    <span className="text-muted-foreground">{i18nT("Coordinates:")}</span>
                    <span className="font-mono font-bold text-foreground">
                      {normalizedAddress.latitude.toFixed(5)}, {normalizedAddress.longitude.toFixed(5)}
                    </span>
                  </div>
                  <div className="flex justify-between border-b border-border/50 pb-1">
                    <span className="text-muted-foreground">{i18nT("GeoHash:")}</span>
                  ...
                  <div className="flex justify-between border-b border-border/50 pb-1">
                    <span className="text-muted-foreground">{i18nT("Mandal/Taluk:")}</span>
                    <span className="text-foreground">{normalizedAddress.mandalTaluk || "N/A"}</span>
                  </div>
                  <div className="flex justify-between border-b border-border/50 pb-1">
                    <span className="text-muted-foreground">{i18nT("District:")}</span>
                    <span className="text-foreground">{normalizedAddress.district}</span>
                  </div>
                  <div className="flex justify-between border-b border-border/50 pb-1">
                    <span className="text-muted-foreground">{i18nT("Pincode:")}</span>
                    <span className="font-mono text-foreground">{normalizedAddress.pincode}</span>
                  </div>
                  <div className="flex justify-between pb-1">
                    <span className="text-muted-foreground">{i18nT("Country:")}</span>
          ...
          <Card className="glass-panel border-border shadow-(--shadow-luxury) backdrop-blur-md">
            ...
            <CardContent className="flex flex-col gap-4">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-xs font-semibold block mb-1 text-muted-foreground">{i18nT("Latitude")}</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="text-xs font-semibold block mb-1 text-muted-foreground">{i18nT("Longitude")}</label>
                  <input
                    type="number"
              ...
              <div className="flex flex-col gap-2 text-xs bg-muted/30 p-3 rounded-lg border border-border">
                  <div className="flex justify-between border-b border-border/50 pb-1">
                    <span className="text-muted-foreground">{i18nT("Distance:")}</span>
                    <span className="font-semibold text-foreground">
                      {(routeData.distanceMeters / 1000).toFixed(2)}{i18nT("km")}
                  </span>
                  </div>
                  <div className="flex justify-between border-b border-border/50 pb-1">
                ...
                <CardContent className="pt-6 flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-2">
                      ...
                      <div className="flex justify-between items-center gap-2 mt-1">
                        ...
                        disabled={voiceNav.isFirstStep}>{i18nT("Previous")}


                      </Button>
                        <span className="text-xs text-muted-foreground font-semibold">{i18nT("Step")}
                        {voiceNav.currentStepIndex + 1}{i18nT("of")}{voiceNav.directions.length}
                        </span>
                        <Button
                        variant="outline"
                        size="sm"
