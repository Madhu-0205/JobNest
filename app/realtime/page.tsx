...
import { useState, useEffect, useRef, useCallback } from "react";import { useI18n } from "@/lib/i18n/context";
...
export default function RealtimeDashboard() {const { t: i18nT } = useI18n();
            ...
            <CardContent className="flex-1 flex flex-col gap-3 overflow-hidden">
              ...
              <div className="flex flex-col gap-1.5">
                <div className="flex gap-1.5">
                  ...
                  <Button size="sm" onClick={handleSendMessage} className="bg-amber-600 hover:bg-amber-700 h-9 px-3">{i18nT("Send")}
