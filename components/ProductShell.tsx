  ...
  if (!isAuthenticated || !user) {
    return (
      <div className="w-screen h-screen flex flex-col items-center justify-center bg-background gap-3">
        ...
        <span className="text-sm text-muted-foreground">Verifying secure session registry...</span>
      </div>
    );
  }
    ...
    <div className="flex min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-card/40 border-r border-border/40 backdrop-blur-xl shrink-0 h-screen sticky top-0 z-50 p-4">
        <div className="flex items-center gap-3 px-2 py-4 border-b border-border/20 mb-6">
          <span className="w-9 h-9 rounded-xl bg-linear-to-r from-primary to-amber-600 flex items-center justify-center text-background font-extrabold text-xl shadow-luxury">
            J
          </span>
          <div>
            <Typography variant="h3" className="font-bold text-base leading-tight">JobNest Pro</Typography>
            <Typography variant="muted" className="text-[10px] uppercase font-mono tracking-wider text-primary">Enterprise V2</Typography>
          </div>
        </div>
        ...
        <div className="border-t border-border/20 pt-4 flex flex-col gap-3">
          <div className="flex items-center gap-3 px-1">
            ...
            <div className="flex-1 min-w-0">
              ...
              <span className="text-[10px] text-muted-foreground block capitalize">{user.role} Account</span>
            </div>
          </div>
          <Button
            variant="outline"
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="sticky top-0 z-40 w-full bg-background/80 backdrop-blur-md border-b border-border/40 h-16 flex items-center px-4 md:px-6 justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="md:hidden flex items-center gap-2">
              <span className="w-8 h-8 rounded-lg bg-linear-to-r from-primary to-amber-600 flex items-center justify-center text-background font-extrabold text-base">
                J
              </span>
            </div>
          ...
          <form onSubmit={handleGlobalSearch} className="hidden lg:flex items-center max-w-md flex-1 relative">
            <div className={`w-full flex items-center gap-2 px-3 py-1.5 rounded-xl border transition-all duration-200 ${
              ...
              <input
                type="text"
                placeholder="Ask AI Assistant or search gigs globally..."
                value={searchVal}
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              aria-label="Trigger global search query dialog"
            >
            ...
            <div className="relative">
              <select
                ...
                aria-label="Toggle user system language translation"
              >
            ...
            <button
              ...
              aria-label="Switch interface brightness theme"
            >
            ...
            <div className="relative">
              <button
                ...
                aria-label="Show notification logs center"
              >
            ...
            <div className="relative">
              <button
                ...
                aria-label="Open user system settings profile card"
              >
              ...
              >
                <div className="flex items-center justify-between border-b border-border/20 pb-4 mb-4">
                  <div className="flex items-center gap-2.5">
                    <span className="w-8 h-8 rounded-lg bg-linear-to-r from-primary to-amber-600 flex items-center justify-center text-background font-extrabold text-base shadow-luxury">
                      J
                    </span>
                    <Typography variant="h3" className="font-bold text-sm">JobNest Mobile</Typography>
                  </div>
        ...
        <nav className="fixed bottom-0 left-0 right-0 h-16 bg-card/85 backdrop-blur-xl border-t border-border/30 md:hidden flex items-center justify-around z-40 px-2 py-1 safe-bottom pb-safe">
          ...
          >
            ...
            <span className="text-[9px] mt-1">AI Search</span>
          </Link>
        ...
        <div className="fixed bottom-20 right-4 z-40 md:hidden flex flex-col gap-2">
          ...
          {user.role === "worker" ? (
            <button
              ...
              aria-label="Send emergency distress SOS signal"
            >
            ...
            <button
              ...
              aria-label="Create new hyperlocal gig opportunity"
            >
          ...
          <div className="fixed inset-0 bg-rose-950/80 backdrop-blur-xs flex items-center justify-center z-[9999] p-4">
            <Card className="glass-panel border-rose-500/40 max-w-sm w-full p-6 flex flex-col gap-4 text-center shadow-luxury animate-in fade-in zoom-in-95 duration-200">
              ...
              <div className="flex flex-col gap-1">
                <Typography variant="h3" className="font-black text-rose-500 text-lg tracking-tight">🚨 Emergency SOS Active</Typography>
                <span className="text-[11px] text-muted-foreground leading-relaxed mt-1">
                  Live telemetry coordinates & Aadhaar KYC identity packet broadcasted to local emergency dispatchers.
                </span>
              </div>
              <Button
                variant="outline"
                onClick={() => setSosActive(false)}
                className="border-rose-500/30 text-rose-400 hover:bg-rose-500/10 hover:text-rose-300 w-full rounded-xl text-xs py-2 h-9 font-bold"
              >
                Deactivate SOS Signal
              </Button>
            </Card>
          </div>
        )}
